	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( _AlbedoColor * tex2D( _AlbedoMap, uv_AlbedoMap ) ).rgb;
				...
				surfaceDescription.Smoothness = ( _SmoothnessAmount * tex2DNode3.a );
...
WireConnection;134;1;2;0
WireConnection;134;6;131;0
WireConnection;134;7;125;0
WireConnection;134;8;3;2
ASEEND*/
//CHKSM=5947A9AB404D3B018187BBAF1D158A9681A6E350