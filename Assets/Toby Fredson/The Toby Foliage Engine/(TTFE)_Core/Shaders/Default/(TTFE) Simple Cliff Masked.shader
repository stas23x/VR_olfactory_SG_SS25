	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_DetailAlbedo579 = packedInput.ase_texcoord5.xy;
				float2 texCoord572 = packedInput.ase_texcoord5.xy * _RockTiling + _RockOffset;
				float2 texCoord583 = packedInput.ase_texcoord5.xy * _CoverTiling + _CoverOffset;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				float2 appendResult645 = (float2(ase_parentObjectScale.x , ase_parentObjectScale.z));
				float2 texCoord648 = packedInput.ase_texcoord5.xy * ( appendResult645 * _WorldScale ) + float2( 0,0 );
				float2 uv_DetailLayerMask585 = packedInput.ase_texcoord5.xy;
				...
				float2 uv_DetailNormal578 = packedInput.ase_texcoord5.xy;
				float3 lerpResult597 = lerp( UnpackNormalScale( tex2D( _RockNormal, texCoord572 ), 1.0 ) , UnpackNormalScale( tex2D( _CoverNormal, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) ), 1.0 ) , temp_output_635_0);
				
				float3 temp_cast_4 = (( _TTFELIGHTSIMPLECLIFFMASKED + _BASELAYER + _DIVIDER_01 + _ROCKLAYER + _DIVIDER_02 + _COVERLAYER + _DIVIDER_03 )).xxx;
				
				float2 uv_DetailMask577 = packedInput.ase_texcoord5.xy;
				...
				surfaceDescription.BaseColor = lerpResult592.rgb;
				surfaceDescription.Normal = BlendNormal( UnpackNormalScale( tex2D( _DetailNormal, uv_DetailNormal578 ), 1.0 ) , lerpResult597 );
				...
				surfaceDescription.Emission = temp_cast_4;
				surfaceDescription.Smoothness = ( tex2DNode577.a * lerpResult601 );
				surfaceDescription.Occlusion = ( pow( saferPower660 , _MaskAoIntensity ) * pow( saferPower178 , _Float5 ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DetailAlbedo579 = packedInput.ase_texcoord2.xy;
				float2 texCoord572 = packedInput.ase_texcoord2.xy * _RockTiling + _RockOffset;
				float2 texCoord583 = packedInput.ase_texcoord2.xy * _CoverTiling + _CoverOffset;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				float2 appendResult645 = (float2(ase_parentObjectScale.x , ase_parentObjectScale.z));
				float2 texCoord648 = packedInput.ase_texcoord2.xy * ( appendResult645 * _WorldScale ) + float2( 0,0 );
				float2 uv_DetailLayerMask585 = packedInput.ase_texcoord2.xy;
				...
				float2 uv_DetailNormal578 = packedInput.ase_texcoord2.xy;
				float3 lerpResult597 = lerp( UnpackNormalScale( tex2D( _RockNormal, texCoord572 ), 1.0 ) , UnpackNormalScale( tex2D( _CoverNormal, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) ), 1.0 ) , temp_output_635_0);
				
				float3 temp_cast_4 = (( _TTFELIGHTSIMPLECLIFFMASKED + _BASELAYER + _DIVIDER_01 + _ROCKLAYER + _DIVIDER_02 + _COVERLAYER + _DIVIDER_03 )).xxx;
				
				float2 uv_DetailMask577 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode577 = tex2D( _DetailMask, uv_DetailMask577 );
				float4 tex2DNode568 = tex2D( _RockMetallicAoGloss, texCoord572 );
				float4 tex2DNode576 = tex2D( _CoverMetallicAoGloss, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) );
				float lerpResult601 = lerp( tex2DNode568.a , tex2DNode576.a , temp_output_635_0);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_DetailNormal578 = packedInput.ase_texcoord3.xy;
				float2 texCoord572 = packedInput.ase_texcoord3.xy * _RockTiling + _RockOffset;
				float2 texCoord583 = packedInput.ase_texcoord3.xy * _CoverTiling + _CoverOffset;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				float2 appendResult645 = (float2(ase_parentObjectScale.x , ase_parentObjectScale.z));
				float2 texCoord648 = packedInput.ase_texcoord3.xy * ( appendResult645 * _WorldScale ) + float2( 0,0 );
				float2 uv_DetailLayerMask585 = packedInput.ase_texcoord3.xy;
				float3 temp_output_618_0 = abs( normalWS );
				float dotResult620 = dot( temp_output_618_0 , float3(1,1,1) );
				float temp_output_635_0 = saturate( ( tex2D( _DetailLayerMask, uv_DetailLayerMask585 ).g * ( saturate( ( normalWS.y * _CoverageAmount ) ) * saturate( (( temp_output_618_0 / dotResult620 ).y*_SlopeMax1 + _SlopeMin1) ) ) ) );
				float3 lerpResult597 = lerp( UnpackNormalScale( tex2D( _RockNormal, texCoord572 ), 1.0 ) , UnpackNormalScale( tex2D( _CoverNormal, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) ), 1.0 ) , temp_output_635_0);
				
				float2 uv_DetailMask577 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode577 = tex2D( _DetailMask, uv_DetailMask577 );
				float4 tex2DNode568 = tex2D( _RockMetallicAoGloss, texCoord572 );
				float4 tex2DNode576 = tex2D( _CoverMetallicAoGloss, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) );
				float lerpResult601 = lerp( tex2DNode568.a , tex2DNode576.a , temp_output_635_0);
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DetailAlbedo579 = packedInput.ase_texcoord7.xy;
				float2 texCoord572 = packedInput.ase_texcoord7.xy * _RockTiling + _RockOffset;
				float2 texCoord583 = packedInput.ase_texcoord7.xy * _CoverTiling + _CoverOffset;
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				float2 appendResult645 = (float2(ase_parentObjectScale.x , ase_parentObjectScale.z));
				float2 texCoord648 = packedInput.ase_texcoord7.xy * ( appendResult645 * _WorldScale ) + float2( 0,0 );
				float2 uv_DetailLayerMask585 = packedInput.ase_texcoord7.xy;
				float3 temp_output_618_0 = abs( normalWS );
				float dotResult620 = dot( temp_output_618_0 , float3(1,1,1) );
				float temp_output_635_0 = saturate( ( tex2D( _DetailLayerMask, uv_DetailLayerMask585 ).g * ( saturate( ( normalWS.y * _CoverageAmount ) ) * saturate( (( temp_output_618_0 / dotResult620 ).y*_SlopeMax1 + _SlopeMin1) ) ) ) );
				float4 lerpResult592 = lerp( ( tex2D( _DetailAlbedo, uv_DetailAlbedo579 ) * unity_ColorSpaceDouble * tex2D( _RockAlbedo, texCoord572 ) * _RockColor ) , ( tex2D( _CoverAlbedo, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) ) * _CoverColor ) , temp_output_635_0);
				
				float2 uv_DetailNormal578 = packedInput.ase_texcoord7.xy;
				float3 lerpResult597 = lerp( UnpackNormalScale( tex2D( _RockNormal, texCoord572 ), 1.0 ) , UnpackNormalScale( tex2D( _CoverNormal, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) ), 1.0 ) , temp_output_635_0);
				
				float3 temp_cast_4 = (( _TTFELIGHTSIMPLECLIFFMASKED + _BASELAYER + _DIVIDER_01 + _ROCKLAYER + _DIVIDER_02 + _COVERLAYER + _DIVIDER_03 )).xxx;
				
				float2 uv_DetailMask577 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode577 = tex2D( _DetailMask, uv_DetailMask577 );
				float4 tex2DNode568 = tex2D( _RockMetallicAoGloss, texCoord572 );
				float4 tex2DNode576 = tex2D( _CoverMetallicAoGloss, (( _PreserveScaling )?( texCoord648 ):( texCoord583 )) );
				float lerpResult601 = lerp( tex2DNode568.a , tex2DNode576.a , temp_output_635_0);
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.CommentaryNode;588;-3248,2304;Inherit;False;1836.785;1026.24;;9;611;565;574;575;576;654;580;642;713;Coverage Layer Mask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;623;-1952,4400;Inherit;False;Property;_SlopeMin1;Slope Min;28;0;Create;True;0;0;0;False;0;False;0;-1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;624;-1952,4320;Inherit;False;Property;_SlopeMax1;Slope Max;27;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;612;-2016,3904;Float;False;Property;_CoverageAmount;Coverage Amount;25;0;Create;True;0;0;0;False;0;False;1;5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;650;-2976,3008;Inherit;False;Property;_WorldScale;World Scale;30;0;Create;True;0;0;0;False;0;False;0.01;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;582;-2784,2448;Float;False;Property;_CoverTiling;Cover Tiling;23;1;[Header];Create;True;2;Cover Texture Settings;(Tiling and Offset);0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;581;-2784,2608;Float;False;Property;_CoverOffset;Cover Offset;24;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ToggleSwitchNode;654;-2288,2704;Inherit;False;Property;_PreserveScaling;Preserve Scaling;29;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;576;-2000,2848;Inherit;True;Property;_CoverMetallicAoGloss;Cover Metallic/Ao/Gloss;22;1;[NoScaleOffset];Create;True;0;0;0;False;1;TTFE_Drawer_SingleLineTexture;False;-1;None;e3e17f7ee6882624bbec7de8d04946e2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;570;-2480,1888;Float;False;Property;_RockOffset;Rock Offset;15;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;571;-2480,1728;Float;False;Property;_RockTiling;Rock Tiling;14;1;[Header];Create;True;2;Rock Texture Settings;(Tiling and Offset);0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;565;-1920,3072;Inherit;False;Property;_CoverColor;Cover Color;26;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;577;-1792,880;Inherit;True;Property;_DetailMask;Detail Mask;4;1;[NoScaleOffset];Create;True;0;0;0;False;1;TTFE_Drawer_SingleLineTexture;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;568;-1824,1952;Inherit;True;Property;_RockMetallicAoGloss;Rock Metallic/Ao/Gloss;13;1;[NoScaleOffset];Create;True;0;0;0;False;1;TTFE_Drawer_SingleLineTexture;False;-1;None;ce054b904524a4346a8c8d77a8d067ad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;574;-2000,2384;Inherit;True;Property;_CoverAlbedo;Cover Albedo;20;2;[Header];[NoScaleOffset];Create;True;1;Texture Maps;0;0;False;2;TTFE_Drawer_SingleLineTexture;Space (5);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;573;-2336,2080;Inherit;False;Property;_RockNormalIntensity;Rock Normal Intensity;17;0;Create;True;0;0;0;False;0;False;1;1;-3;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;600;-720,2352;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;158;-768,2592;Float;False;Property;_Float5;Main Ao Intensity;8;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;658;-752,2704;Inherit;False;Property;_MaskAoIntensity;Mask Ao Intensity;7;1;[Header];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;608;-1296,624;Inherit;False;Property;_RockColor;Rock Color;16;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;694;-48,-288;Inherit;False;Property;_DIVIDER_01;DIVIDER_01;9;0;Create;True;0;0;0;False;1;TTFE_DrawerDivider;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;693;-48,-208;Inherit;False;Property;_ROCKLAYER;ROCK LAYER;10;1;[Header];Create;True;0;0;0;False;1;TTFE_DrawerFeatureBorder;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;695;-48,-128;Inherit;False;Property;_DIVIDER_02;DIVIDER_02;18;0;Create;True;0;0;0;False;1;TTFE_DrawerDivider;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;696;-48,-32;Inherit;False;Property;_COVERLAYER;COVER LAYER;19;0;Create;True;0;0;0;False;1;TTFE_DrawerFeatureBorder;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;697;-48,48;Inherit;False;Property;_DIVIDER_03;DIVIDER_03;31;0;Create;True;0;0;0;False;1;TTFE_DrawerDivider;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;597;0;712;0
WireConnection;597;1;713;0
WireConnection;597;2;635;0
WireConnection;606;0;711;0
...
WireConnection;711;0;578;0
WireConnection;567;1;572;0
WireConnection;575;1;654;0
WireConnection;713;0;575;0
WireConnection;712;0;567;0
WireConnection;700;0;592;0
WireConnection;700;1;606;0
WireConnection;700;6;698;0
WireConnection;700;7;656;0
WireConnection;700;8;657;0
ASEEND*/
//CHKSM=3839AFCEF0130CBB7FABB9F95029CC18C8CD7F73