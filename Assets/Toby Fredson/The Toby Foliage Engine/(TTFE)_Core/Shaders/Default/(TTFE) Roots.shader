	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlbedoMap1 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode1 = tex2D( _AlbedoMap, uv_AlbedoMap1 );
				
				float2 uv_NormalMap2 = packedInput.ase_texcoord5.xy;
				
				float3 temp_cast_1 = (( _TTFELIGHTROOTSSHADER + _TEXTUREMAPS + _DIVIDER_01 )).xxx;
				
				float2 uv_MaskMap3 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode3 = tex2D( _MaskMap, uv_MaskMap3 );
				
				surfaceDescription.BaseColor = tex2DNode1.rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap2 ), 1.0f );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap1 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode1 = tex2D( _AlbedoMap, uv_AlbedoMap1 );
				
				float2 uv_NormalMap2 = packedInput.ase_texcoord2.xy;
				
				float3 temp_cast_1 = (( _TTFELIGHTROOTSSHADER + _TEXTUREMAPS + _DIVIDER_01 )).xxx;
				
				float2 uv_MaskMap3 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode3 = tex2D( _MaskMap, uv_MaskMap3 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_AlbedoMap1 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode1 = tex2D( _AlbedoMap, uv_AlbedoMap1 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_NormalMap2 = packedInput.ase_texcoord3.xy;
				
				float2 uv_MaskMap3 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode3 = tex2D( _MaskMap, uv_MaskMap3 );
				
				float2 uv_AlbedoMap1 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode1 = tex2D( _AlbedoMap, uv_AlbedoMap1 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap1 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode1 = tex2D( _AlbedoMap, uv_AlbedoMap1 );
				
				float2 uv_NormalMap2 = packedInput.ase_texcoord7.xy;
				
				float3 temp_cast_1 = (( _TTFELIGHTROOTSSHADER + _TEXTUREMAPS + _DIVIDER_01 )).xxx;
				
				float2 uv_MaskMap3 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode3 = tex2D( _MaskMap, uv_MaskMap3 );
...
WireConnection;26;6;22;0
WireConnection;26;7;3;4
WireConnection;26;8;3;2
WireConnection;26;9;1;4
ASEEND*/
//CHKSM=44BC5B8D1138C604E413D91F1A15F1906CB88AEA