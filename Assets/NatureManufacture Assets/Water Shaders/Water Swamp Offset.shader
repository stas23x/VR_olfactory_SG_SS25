Shader "NatureManufacture/Water/Swamp Offset"
{
	Properties
	{
...
#define _Detail_2_Smoothness_Remap_Max_arr Graph_NM_Swamp
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half clampResult918 = clamp( switchResult661 , 0.0 , 1.0 );
			#ifdef DIRECTIONAL_COOKIE
				half staticSwitch916 = clampResult918;
			#else
				half staticSwitch916 = 1.0;
			#endif
			o.Albedo = ( lerpResult900 * staticSwitch916 ).rgb;
			...
			o.Specular = ( lerpResult905 * staticSwitch916 ).rgb;
			...
			o.Occlusion = ( break908.y * staticSwitch916 );
			o.Alpha = clampResult918;
		}
