    ...
    internal class NewLocation
    {
            ...
            double[] points, ref double[] newloc)
        {
            ...
            for (i = 0; i < numpoints * 2; i = i + 2)
            {
                ...
                for (j = 1; j < 4; j++)
                {
                    ...
                    x_3 = x3 * Math.Cos((Math.PI / 3.0 - alpha) * j) + y3 * Math.Sin((Math.PI / 3.0 - alpha) * j) + petalx[i / 2] - petalx[i / 2] * Math.Cos((Math.PI / 3.0 - alpha) * j) -
                          petaly[i / 2] * Math.Sin((Math.PI / 3.0 - alpha) * j);
                    y_3 = -x3 * Math.Sin((Math.PI / 3.0 - alpha) * j) + y3 * Math.Cos((Math.PI / 3.0 - alpha) * j) + petaly[i / 2] + petalx[i / 2] * Math.Sin((Math.PI / 3.0 - alpha) * j) -
                ...
                for (j = 1; j < 4; j++)
                {
                    ...
                    x_4 = x3 * Math.Cos((Math.PI / 3.0 - alpha) * j) - y3 * Math.Sin((Math.PI / 3.0 - alpha) * j) + petalx[i / 2] - petalx[i / 2] * Math.Cos((Math.PI / 3.0 - alpha) * j) +
                          petaly[i / 2] * Math.Sin((Math.PI / 3.0 - alpha) * j);
                    y_4 = x3 * Math.Sin((Math.PI / 3.0 - alpha) * j) + y3 * Math.Cos((Math.PI / 3.0 - alpha) * j) + petaly[i / 2] - petalx[i / 2] * Math.Sin((Math.PI / 3.0 - alpha) * j) -
                          petaly[i / 2] * Math.Cos((Math.PI / 3.0 - alpha) * j);
            ...
            if (numpoints != 0)
            {
                ...
                while (count < numpoints - 1)
                {
                    for (j = 0; j < 32; j = j + 4)
                    {
                        numpolypoints = HalfPlaneIntersection(num, ref initialConvexPoly, wedges[32 * (i + s * flag) + j], wedges[32 * (i + s * flag) + 1 + j], wedges[32 * (i + s * flag) + 2 + j],
                            wedges[32 * (i + s * flag) + 3 + j]);
                        if (numpolypoints == 0)
                            return false;
                        num = numpolypoints;
                    }
        ...
        private bool GetWedgeIntersection(int numpoints, double[] points, ref double[] newloc)
        {
            ...
            for (i = 0; i < numpoints * 2; i = i + 2)
            {
                ...
                for (j = 1; j < line345; j++)
                {
                    ...
                    x_3 = x3 * Math.Cos(alpha / (line345 - 1.0) * j) + y3 * Math.Sin(alpha / (line345 - 1.0) * j) + petalx[i / 2] - petalx[i / 2] * Math.Cos(alpha / (line345 - 1.0) * j) -
                          petaly[i / 2] * Math.Sin(alpha / (line345 - 1.0) * j);
                    y_3 = -x3 * Math.Sin(alpha / (line345 - 1.0) * j) + y3 * Math.Cos(alpha / (line345 - 1.0) * j) + petaly[i / 2] + petalx[i / 2] * Math.Sin(alpha / (line345 - 1.0) * j) -
                ...
                for (j = 1; j < line789; j++)
                {
                    ...
                    x_4 = x3 * Math.Cos(alpha / (line789 - 1.0) * j) - y3 * Math.Sin(alpha / (line789 - 1.0) * j) + petalx[i / 2] - petalx[i / 2] * Math.Cos(alpha / (line789 - 1.0) * j) +
                          petaly[i / 2] * Math.Sin(alpha / (line789 - 1.0) * j);
                    y_4 = x3 * Math.Sin(alpha / (line789 - 1.0) * j) + y3 * Math.Cos(alpha / (line789 - 1.0) * j) + petaly[i / 2] - petalx[i / 2] * Math.Sin(alpha / (line789 - 1.0) * j) -
            ...
            if (numpoints != 0)
            {
                ...
                while (count < numpoints - 1)
                {
                    for (j = 0; j < 40; j = j + 4)
                    {
                        ...
                        numpolypoints = HalfPlaneIntersection(num, ref initialConvexPoly, wedges[40 * (i + s * flag) + j], wedges[40 * (i + s * flag) + 1 + j], wedges[40 * (i + s * flag) + 2 + j],
                            wedges[40 * (i + s * flag) + 3 + j]);
                ...
                if (behavior.MaxAngle != 0.0)
                {
                    ...
                    for (j = 0; j < numpoints * 2 - 2; j = j + 2)
                        if (IsBadTriangleAngle(newloc[0], newloc[1], points[j], points[j + 1], points[j + 2], points[j + 3]))
                            numBadTriangle++;
                    if (IsBadTriangleAngle(newloc[0], newloc[1], points[0], points[1], points[numpoints * 2 - 2], points[numpoints * 2 - 1])) numBadTriangle++;
        ...
        private bool ValidPolygonAngles(int numpoints, double[] points)
        {
            ...
            for (i = 0; i < numpoints; i++)
                if (i == numpoints - 1)
                {
                    if (IsBadPolygonAngle(points[i * 2], points[i * 2 + 1], points[0], points[1], points[2], points[3])) return false; // one of the inner angles is less than required
                }
                else if (i == numpoints - 2)
                {
                    if (IsBadPolygonAngle(points[i * 2], points[i * 2 + 1], points[(i + 1) * 2], points[(i + 1) * 2 + 1], points[0], points[1])) return false; // one of the inner angles is less than required
                }
                else
                {
                    if (IsBadPolygonAngle(points[i * 2], points[i * 2 + 1], points[(i + 1) * 2], points[(i + 1) * 2 + 1], points[(i + 2) * 2],
                            points[(i + 2) * 2 + 1])) return false; // one of the inner angles is less than required
                }
        ...
        private bool IsBadTriangleAngle(double x1, double y1, double x2, double y2, double x3, double y3)
        {
            ...
            if (angle > behavior.goodAngle || (behavior.MaxAngle != 0.00 && maxangle < behavior.maxGoodAngle)) return true; // it is a bad triangle
        ...
        private double MinDistanceToNeighbor(double newlocX, double newlocY, ref Otri searchtri)
        {
            ...
            if (intersect == LocateResult.OnVertex || intersect == LocateResult.Outside)
                ...
                return 0.0; // intersect == ONEDGE || intersect == INTRIANGLE
