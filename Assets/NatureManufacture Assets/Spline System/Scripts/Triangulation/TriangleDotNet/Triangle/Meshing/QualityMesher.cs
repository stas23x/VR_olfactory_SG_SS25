...
namespace TriangleNet.Meshing
{
    ...
    internal class QualityMesher
    {
        ...
        public void Apply(QualityOptions quality, bool delaunay = false)
        {
            ...
            if (behavior.useSegments) mesh.checksegments = true;
                    ...
                    base2.type == VertexType.SegmentVertex)
                {
                    ...
                    if (testsub.seg.hash == Mesh.DUMMY)
                    {
                        ...
                        if (dest1.x == org2.x && dest1.y == org2.y)
                            joinvertex = dest1;
                        else if (org1.x == dest2.x && org1.y == dest2.y) joinvertex = org1;
                        if (joinvertex != null)
                        {
