...
namespace TriangleNet.Meshing.Algorithm
{
    ...
    {
        private static readonly int randomseed = 1;
        ...
        public IMesh Triangulate(IList<Vertex> points, Configuration config)
        {
            ...
            while (heapsize > 0)
            {
                ...
                if (nextevent.xkey < mesh.bounds.Left)
                {
                    ...
                    if (farlefttri.Equals(bottommost)) fliptri.Lprev(ref bottommost);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!farrightflag && farrighttri.Equals(bottommost)) lefttri.Copy(ref bottommost);
            ...
            do
            {
                ...
                if (noPoly)
                    ...
                    if (dissolveedge.tri.id != Mesh.DUMMY)
                    {
                        ...
                        if (markorg.label == 0) markorg.label = 1;
                    }
