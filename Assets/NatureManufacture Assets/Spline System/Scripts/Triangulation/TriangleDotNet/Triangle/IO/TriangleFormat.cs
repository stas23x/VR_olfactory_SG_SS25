    ...
    public class TriangleFormat : IPolygonFormat, IMeshFormat
    {
        public IMesh Import(string filename)
        {
            ...
            if (ext == ".node" || ext == ".poly" || ext == ".ele")
            {
                ...
                if (geometry != null && triangles != null) return Converter.ToMesh(geometry, triangles.ToArray());
            }
        ...
        public bool IsSupported(string file)
        {
            ...
            if (ext == ".node" || ext == ".poly" || ext == ".ele") return true;
        ...
        public IPolygon Read(string filename)
        {
            ...
            if (ext == ".poly") return new TriangleReader().ReadPolyFile(filename);
