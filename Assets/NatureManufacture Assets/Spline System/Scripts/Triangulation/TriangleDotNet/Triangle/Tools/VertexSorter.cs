...
namespace TriangleNet.Tools
{
    ...
    public class VertexSorter
    {
        ...
        private VertexSorter(Vertex[] points)
        {
            this.points = points;
        }
        ...
        /// <param name="seed">Random seed used for pivoting.</param>
        public static void Alternate(Vertex[] array, int length)
        {
            var qs = new VertexSorter(array);
            ...
            if (length - divider >= 2)
            {
                if (divider >= 2) qs.AlternateAxes(0, divider - 1, 1);
        ...
        private void QuickSort(int left, int right)
        {
            ...
            pivot = Polygon.GetRandomNext(left, right);
