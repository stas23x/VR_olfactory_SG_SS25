...
namespace TriangleNet.Voronoi
{
    ...
    public abstract class VoronoiBase : DcelMesh
    {
        ...
        protected void Generate(Mesh mesh)
        {
            ...
            if (factory == null) factory = new DefaultVoronoiFactory();
            ...
            foreach (Geometry.Vertex vertex in mesh.vertices.Values) faces[vertex.id] = factory.CreateFace(vertex);
        ...
        protected override IEnumerable<IEdge> EnumerateEdges()
        {
            ...
            foreach (HalfEdge edge in this.edges)
            {
                ...
                else if (edge.id < twin.id) edges.Add(new Edge(edge.origin.id, twin.origin.id));
            }
